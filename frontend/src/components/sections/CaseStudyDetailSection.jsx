    ...
    <section className="relative px-[3rem] pt-[15rem] pb-[5rem] md:pt-[20.6rem] xl:px-[0rem] xl:pb-[9.8rem]">
      ...
      <div className="relative z-[1] mx-auto max-w-[120.3rem]">
        <div className="flex flex-col items-center text-center xl:items-start xl:text-left">
          ...
          <div className="mt-[5.5rem] mb-[5rem] grid w-full grid-cols-1 items-center gap-[1rem] md:grid-cols-2 lg:grid-cols-4 lg:items-start">
            <div className="flex flex-col items-center gap-[.7rem] text-center lg:items-start lg:text-left">
            ...
            <div className="flex flex-col items-center gap-[.8rem] text-center lg:items-start lg:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center gap-[2rem] lg:justify-start">
